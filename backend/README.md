...
## Project Structure
    ...
    ├── throbbing_grass_dev_57191  # Django project configurations
...
1. Clone this repo and `cd throbbing_grass_dev_57191`
...
2. Clone this repo and `cd throbbing_grass_dev_57191`
